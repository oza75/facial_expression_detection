...
from models.classification.custom import DetectVGG16FER
from pipelines import DetectMiniXceptionFER


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Real-time face classifier')
    parser.add_argument('-c', '--camera_id', type=int, default=1,
    ...
    pipeline = DetectVGG16FER([args.offset, args.offset])
